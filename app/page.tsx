...
const HomePageContent = () => {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center pb-20 px-6 relative bg-[#FFF5F7] text-slate-900">
      ...
      {/* --- THE STORY (RESTORED PERFECT ORIGINAL LAYOUT) --- */}
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (unlocked === 'true') {
      ...
      // Let the GlobalMusicPlayer know we are unlocked if they refreshed the page
  ...
  const handleLoginSuccess = () => {
    ...
    // Magic trigger for the GlobalMusicPlayer!
    window.dispatchEvent(new Event('unlockVault')); 
    setIsAuthenticated(true);
  };
